...
class TaskStep(Enum):
    ...
    PUTTING_DOWN_TO_BOTTLE_OPENER_500_AND_250_SUCCESS = "放下瓶子到500ml和250ml开瓶器成功" # 500ml和250ml可以开始开瓶盖/关瓶盖
    ...
    PUTTING_TO_BOTTLE_OPENER_500_AND_250_SUCCESS = "双手把手上的瓶子放到目标开瓶器上成功"
